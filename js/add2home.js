...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			message: 'Install Taxi Tab on your %device: tap %icon and then <strong>Add to Home Screen</strong>. For easy access in the future.',				// Customize your message or force a language ('' = automatic)
